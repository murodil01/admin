...
export const enrichDepartmentsWithLocalData = (
  apiDepartments,
  allDepartments = []
) => {
...
export const transformApiEventToFrontend = async (apiEvent) => {
  ...
  return {
    ...
    file: apiEvent.file
      ? {
          name: apiEvent.file_name,
          url: apiEvent.file,
          downloadUrl: apiEvent.file_url,
        }
      : null,
    departments: enrichDepartmentsWithLocalData(
      apiEvent.departments,
      allDepartments
    ),
    department: enrichDepartmentsWithLocalData(
      apiEvent.departments,
      allDepartments
...
export const transformFrontendEventToApi = (frontendEvent) => {
  ...
  return {
    ...
    notification_time: mapNotificationStringToMinutes(
    ...
    is_active:
      frontendEvent.isActive !== undefined ? frontendEvent.isActive : true, // Default true
  };
};
