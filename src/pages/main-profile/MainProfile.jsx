...
const MainProfile = () => {
  ...
  // Authentication check - AuthContext'dan keladi
  useEffect(() => {
  ...
  const handleSave = useCallback(async () => {
    if (!profileState.user || !isAuthenticated) return;
  ...
  }, [profileState.user, profileState.birthday, passwordState.changePassword, isAuthenticated]);
  ...
  if (!isAuthenticated) {
    return null; // Navigate hook buni handle qiladi
  }
