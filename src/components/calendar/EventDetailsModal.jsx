        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="border rounded-lg p-4 bg-gray-50">
              ...
              {isEditing && (
                <input type="file" accept="image/*" onChange={handleImageChange} className="mt-2 w-full text-sm" />
              )}
            </div>
          </div>
          ...
          {isEditing ? (
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm leading-relaxed">{displayData.description}</p>
            </div>
          ) : null}
          ...
          {isEditing ? (
                ...
                {departments.map((dept) => (
                  <button
                    ...
                    onClick={() => setEditData(prev => ({
                      ...prev,
                      department: prev.department?.id === dept.id ? null : dept,
                    }))}
                    className={`p-2 border rounded-lg text-xs flex items-center space-x-2 ${
                      editData?.department?.id === dept.id ? 'border-blue-500 bg-blue-50' : 'border-gray-300 hover:bg-gray-50'
                    }`}
                  >
                    <span>{dept.icon}</span>
                    <span>{dept.name}</span>
            ...
            <div>
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm text-gray-600">{displayData.department.name}</span>
              </div>
            </div>
          ) : null}
          ...
          {displayData.viewOption && displayData.viewOption !== 'Choose' && (
            <div>
              ...
              <span className="text-sm text-gray-600">{displayData.viewOption}</span>
            </div>
          )}
        </div>
