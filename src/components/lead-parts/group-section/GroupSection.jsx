...
const GroupSection = ({
  ...
  // API dan kelgan datani to'g'ri formatga o'tkazish
  useEffect(() => {
    if (items && Array.isArray(items)) {
      const formattedItems = items.map((item) => ({
        ...
        group: item.group || id,
        // API da timeline_start/timeline_end sifatida keladi
        timeline: {
          start: item.timeline_start || null,
          end: item.timeline_end || null,
        },
        // API data structure ni saqlab qolish
  ...
  const saveEditCell = async () => {
    ...
    // Timeline uchun maxsus ishlov berish
    const updateData = {};
    if (field === "timeline") {
    ...
    console.log("Updating lead:", item.id, "with data:", updateData);
  ...
  const saveNewItem = async () => {
    ...
    console.log("Creating new lead:", newItem);
  ...
  console.log("Rendering GroupSection with items:", localItems);
